...
if not app.debug:
  if app.config['MAIL_SERVER']:
    ...
    mail_handler = SMTPHandler(
      ...
      toaddrs=app.config['ADMINS'], subject='ph-hospital Failure',
  ...
  if not os.path.exists('logs'):
    os.mkdir('logs')
  file_handler = RotatingFileHandler('logs/ph_hospital.log', maxBytes=10240,
                                     backupCount=10)
  ...
  app.logger.info('ph-hospital startup')
